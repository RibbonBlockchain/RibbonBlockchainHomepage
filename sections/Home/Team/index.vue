      ...
      <div class="row">
        <div class="col-md-10 offset-md-1">
          <div class="title text-center">
            <h3>Core team</h3>
            <p>
              Ribbon has a experienced, interdisciplinary team who is perfectly
              positioned to realise the potential of healthcare incentives.
            </p>
          </div>
        </div>
        <div class="w-100"></div>
      ...
      <div class="row">
        ...
        <!-- <div class="col-md-3">
          <div class="teams_single_in" data-aos="fade-up" data-aos-duration="1000">
            ...
            <ul class="social">
              <li>
                <a href="https://www.linkedin.com/in/mekyle-naidoo-3a7ab2160/">
                  <i class="fab fa-linkedin-in"></i>
                </a>
              </li>
            </ul>
        ...
        <div class="col-md-3">
          ...
          >
            ...
            <ul class="social">
              <li>
                <a href="https://github.com/Nicca42">
                  <i class="fab fa-github"></i>
                </a>
              </li>
              <li>
                <a href="https://gitlab.com/VeronicaLC">
                  <i class="fab fa-gitlab"></i>
                </a>
              </li>
              <li>
                <a
                  href="https://www.linkedin.com/in/veronica-coutts-aa5915149/"
                >
                  <i class="fab fa-linkedin-in"></i>
                </a>
              </li>
        ...
        <div class="col-md-3">
          ...
          >
            ...
            <ul class="social">
              <li>
                <a href="https://www.linkedin.com/in/neo-moselekwa-2482886b/">
                  <i class="fab fa-linkedin-in"></i>
                </a>
              </li>
            </ul>
            <div class="name">
              <h4>Neo Moselekwa</h4>
              <p class="h6" style="padding-top: 5px">Social Media Manager</p>
            </div>
          </div>
        </div>
      </div>
