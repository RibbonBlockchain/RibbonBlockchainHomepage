      ...
      <div class="row">
        <div class="col-md-10 offset-md-1">
          <div class="title text-center">
            <h3>Advisory team</h3>
            <p>
              Ribbon has an experienced advisory team which is perfectly
        ...
        <div class="col-md-2">
          ...
          >
            ...
            <div class="name">
              <h4>Chris maree</h4>
              <p class="h6" style="padding-top: 5px">Software Architect</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-2">
          ...
          >
            ...
            <ul class="social">
              <li>
                <a
                  href="https://www.linkedin.com/in/dr-brenda-kubheka-7a1b1917/"
                >
                  <i class="fab fa-linkedin-in"></i>
                </a>
              </li>
            ...
            <div class="name">
              ...
              <p class="h6" style="padding-top: 5px">
